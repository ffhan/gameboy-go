...
var ( // todo check table (especially loads)
	optable = [...]Instr{
		...
		add8b(rx(go_gb.A), rx(go_gb.B)), add8b(rx(go_gb.A), rx(go_gb.C)), add8b(rx(go_gb.A), rx(go_gb.D)), add8b(rx(go_gb.A), rx(go_gb.E)), add8b(rx(go_gb.A), rx(go_gb.H)), add8b(rx(go_gb.A), rx(go_gb.L)), add8b(rx(go_gb.A), mr(go_gb.HL)), add8b(rx(go_gb.A), rx(go_gb.A)), adc8b(rx(go_gb.A), rx(go_gb.B)), adc8b(rx(go_gb.A), rx(go_gb.C)), adc8b(rx(go_gb.A), rx(go_gb.D)), adc8b(rx(go_gb.A), rx(go_gb.E)), adc8b(rx(go_gb.A), rx(go_gb.H)), adc8b(rx(go_gb.A), rx(go_gb.L)), adc8b(rx(go_gb.A), mr(go_gb.HL)), adc8b(rx(go_gb.A), rx(go_gb.A)),
		sub(rx(go_gb.A), rx(go_gb.B)), sub(rx(go_gb.A), rx(go_gb.C)), sub(rx(go_gb.A), rx(go_gb.D)), sub(rx(go_gb.A), rx(go_gb.E)), sub(rx(go_gb.A), rx(go_gb.H)), sub(rx(go_gb.A), rx(go_gb.L)), sub(rx(go_gb.A), mr(go_gb.HL)), sub(rx(go_gb.A), rx(go_gb.A)), sbc(rx(go_gb.A), rx(go_gb.B)), sbc(rx(go_gb.A), rx(go_gb.C)), sbc(rx(go_gb.A), rx(go_gb.D)), sbc(rx(go_gb.A), rx(go_gb.E)), sbc(rx(go_gb.A), rx(go_gb.H)), sbc(rx(go_gb.A), rx(go_gb.L)), sbc(rx(go_gb.A), mr(go_gb.HL)), sbc(rx(go_gb.A), rx(go_gb.A)),
		and(rx(go_gb.A), rx(go_gb.B)), and(rx(go_gb.A), rx(go_gb.C)), and(rx(go_gb.A), rx(go_gb.D)), and(rx(go_gb.A), rx(go_gb.E)), and(rx(go_gb.A), rx(go_gb.H)), and(rx(go_gb.A), rx(go_gb.L)), and(rx(go_gb.A), mr(go_gb.HL)), and(rx(go_gb.A), rx(go_gb.A)), xor(rx(go_gb.A), rx(go_gb.B)), xor(rx(go_gb.A), rx(go_gb.C)), xor(rx(go_gb.A), rx(go_gb.D)), xor(rx(go_gb.A), rx(go_gb.E)), xor(rx(go_gb.A), rx(go_gb.H)), xor(rx(go_gb.A), rx(go_gb.L)), xor(rx(go_gb.A), mr(go_gb.HL)), xor(rx(go_gb.A), rx(go_gb.A)),
		or(rx(go_gb.A), rx(go_gb.B)), or(rx(go_gb.A), rx(go_gb.C)), or(rx(go_gb.A), rx(go_gb.D)), or(rx(go_gb.A), rx(go_gb.E)), or(rx(go_gb.A), rx(go_gb.H)), or(rx(go_gb.A), rx(go_gb.L)), or(rx(go_gb.A), mr(go_gb.HL)), or(rx(go_gb.A), rx(go_gb.A)), cp(rx(go_gb.A), rx(go_gb.B)), cp(rx(go_gb.A), rx(go_gb.C)), cp(rx(go_gb.A), rx(go_gb.D)), cp(rx(go_gb.A), rx(go_gb.E)), cp(rx(go_gb.A), rx(go_gb.H)), cp(rx(go_gb.A), rx(go_gb.L)), cp(rx(go_gb.A), mr(go_gb.HL)), cp(rx(go_gb.A), rx(go_gb.A)),

		retnc(BitZ), pop(rx(go_gb.BC)), jpnc(BitZ, dx(16)), jp(dx(16)), callcc(BitZ), push(rx(go_gb.BC)), add8b(rx(go_gb.A), dx(8)), rst(hc(0x00)), retc(BitZ), ret, jpc(BitZ, dx(16)), prefix, callc(BitZ), call, adc8b(rx(go_gb.A), dx(8)), rst(hc(0x08)),
		retnc(BitC), pop(rx(go_gb.DE)), jpnc(BitC, dx(16)), invalid, callcc(BitC), push(rx(go_gb.DE)), sub(rx(go_gb.A), dx(8)), rst(hc(0x10)), retc(BitC), reti, jpc(BitC, dx(16)), invalid, callc(BitC), invalid, sbc(rx(go_gb.A), dx(8)), rst(hc(0x18)),
		load(mem(off(dx(8))), rx(go_gb.A)), pop(rx(go_gb.HL)), load(mem(off(rx(go_gb.C))), rx(go_gb.A)), invalid, invalid, push(rx(go_gb.HL)), and(rx(go_gb.A), dx(8)), rst(hc(0x20)), addSp, jpHl, load(md(16), rx(go_gb.A)), invalid, invalid, invalid, xor(rx(go_gb.A), dx(8)), rst(hc(0x28)),
		load(rx(go_gb.A), mem(off(dx(8)))), pop(rx(go_gb.AF)), load(rx(go_gb.A), mem(off(rx(go_gb.C)))), di, invalid, push(rx(go_gb.AF)), or(rx(go_gb.A), dx(8)), rst(hc(0x30)), ldHlSp, ldSpHl, load(rx(go_gb.A), md(16)), ei, invalid, invalid, cp(rx(go_gb.A), dx(8)), rst(hc(0x38)),
	}
